...
export enum PaymentMethodEnum {
  ...
  NET_BANKING = "NET_BANKING", // 🇮🇳 India specific
  WALLET = "WALLET",        // 🇮🇳 India specific
  OTHER = "OTHER",
}
...
export interface TransactionDocument extends Document {
  ...
  title: string;
  amount: number;
  category: keyof typeof CategoryEnum;  // Changed from string
  receiptUrl?: string;
...
const transactionSchema = new Schema<TransactionDocument>(
  {
    ...
    category: {
      type: String,
      enum: Object.values(CategoryEnum),  // 🇮🇳 Added enum validation
      required: true,
    },
    receiptUrl: {
      type: String,
